    ...
    <div className="min-h-screen bg-candlelight-beige">
      ...
      <div className="px-6 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Card className="mb-8">
              <CardHeader className="bg-gradient-to-r from-ink-blue to-forest-green text-white">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-forest-green text-sm">Per Session</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-xl text-ink-blue">Flexible</div>
                      <div className="text-forest-green text-sm">Scheduling</div>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-serif text-2xl text-ink-blue">Book Your Session</CardTitle>
                <CardDescription>
                  Schedule your individual coaching session.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="message">What would you like to focus on? (optional)</Label>
                    <Textarea
                      id="message"
                      value={formData.message}
                      onChange={(e) => setFormData(prev => ({ ...prev, message: e.target.value }))}
                      placeholder="Share what you'd like to explore in our session..."
